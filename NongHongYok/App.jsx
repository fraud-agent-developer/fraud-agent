...
function App() {
  ...
  const [enableESlipCustomization, setEnableESlipCustomization] =
    useState(false);
  ...
  const birdMessages = {
    ...
    [MASCOT_STATES.WARNING]: {
      ...
      message:
        "น้องเจอสัญญาณเตือนหลายอย่างเลยค่ะ ขอให้โทรถามคนที่จะโอนให้ หรือปรึกษาคนในครอบครัวก่อนนะคะ ถ้าเป็นเรื่องจริง รอได้แน่นอนค่ะ",
    ...
    [MASCOT_STATES.PRESSURE]: {
      ...
      message:
        "น้องหงส์หยกสังเกตว่าคุณกดเร็วผิดปกติ มีใครเร่งให้โอนหรือเปล่าคะ? มิจฉาชีพชอบใช้เทคนิคนี้มากเลย หายใจลึกๆ คิดใหม่อีกทีนะคะ",
    ...
    [MASCOT_STATES.BLOCKED]: {
      ...
      message:
        "ระบบตรวจพบความผิดปกติ หากโอนไปแล้วอาจเรียกคืนได้ยาก กรุณาติดต่อธนาคารก่อนดำเนินการค่ะ",
  ...
  const defaultTransferBird = {
    ...
    message:
      "รู้หรือไม่: มิจฉาชีพมืออาชีพใช้เวลาเฉลี่ย 18 นาทีในการหลอก - ถ้ารู้สึกถูกเร่ง หยุด 5 นาที โทรหาคนที่ไว้ใจ",
  ...
  const mascotConfig = {
    ...
    [MASCOT_STATES.CAUTION]: {
      ...
      subtitle:
        "You have never transferred to Ms. Rattana Dee before. Please check the account number carefully.",
    },
    [MASCOT_STATES.WARNING]: {
      color: "bg-orange-100",
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative flex flex-col">
        ...
        <div className="bg-[#3d4f5c] text-white p-2 flex gap-2 flex-wrap justify-between items-center px-3">
          <span className="text-[10px] font-semibold text-[#f5a623] uppercase tracking-wide">
            Dev Mode
          </span>
              ...
              <button
                ...
                className={`px-2.5 py-1.5 rounded-md text-xs font-semibold transition-all ${
                  selectedScenario === state
                    ? state === MASCOT_STATES.TRANSFER
                      ? "bg-blue-500 text-white shadow-md"
                      : state === MASCOT_STATES.SAFE
                      ? "bg-white text-gray-900 shadow-md"
                      : state === MASCOT_STATES.CAUTION
                      ? "bg-[#c89a3f] text-white shadow-md"
                      : state === MASCOT_STATES.WARNING
                      ? "bg-[#e67e22] text-white shadow-md"
                      : state === MASCOT_STATES.PRESSURE
    ...
    <div className="min-h-screen bg-gray-100 relative flex flex-col">
      ...
      <div
        className={`flex-1 flex flex-col transition-all duration-300 ${
          showIntervention ? "blur-sm opacity-50" : ""
        }`}
      >
        {/* Header */}
            ...
            <div className="px-5 py-6 flex-1">
              ...
              <div className="flex items-start gap-3 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-bold text-[#00a9cc] text-base leading-tight">
                    {transaction.recipientName}
                  </p>
                  <p className="text-sm text-gray-500 mt-0.5">
                    {transaction.recipientAccount}
              ...
              <div className="flex gap-4 items-start pt-2">
                ...
                <div className="flex-shrink-0">
                  {birdMessages[selectedScenario]?.birdImagePath ||
                  birdMessages.default.birdImagePath ? (
                    <img
                      src={
                        birdMessages[selectedScenario]?.birdImagePath ||
                        birdMessages.default.birdImagePath
                ...
                <div className="flex-1 relative">
                  ...
                  <div
                    className={`absolute left-[-10px] top-5 w-0 h-0 border-t-[10px] border-t-transparent border-b-[10px] border-b-transparent border-r-[12px] ${
                      selectedScenario === MASCOT_STATES.SAFE
                        ? "border-r-green-200"
                        : selectedScenario === MASCOT_STATES.CAUTION
                        ? "border-r-yellow-200"
                  ...
                  >
                    ...
                    >
                      {birdMessages[selectedScenario]?.title ||
                        birdMessages.default.title}
                    </p>
                    <p
                    ...
                    >
                      {birdMessages[selectedScenario]?.message ||
                        birdMessages.default.message}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-gray-700 leading-relaxed">
                        ชื่อผู้รับตรงกับคนที่คุณต้องการโอนเงินให้
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-yellow-600 mt-1 text-lg">✓</span>
                ...
                <div className="mt-5 bg-white border-2 border-red-400 rounded-2xl p-5 shadow-lg">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <span className="text-red-600 mt-1 text-lg">•</span>
                      <span className="text-sm text-gray-800 leading-relaxed font-medium">
                        บัญชีปลายทางถูกรายงานว่าเกี่ยวข้องกับการฉ้อโกง
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-red-600 mt-1 text-lg">•</span>
                      <span className="text-sm text-gray-800 leading-relaxed font-medium">
                        มีรูปแบบการโอนเงินที่ผิดปกติ
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-red-600 mt-1 text-lg">•</span>
                      <span className="text-sm text-gray-800 leading-relaxed font-medium">
                        ระบบตรวจพบความเสี่ยงระดับสูงสุด
                      </span>
                    </li>
                  </ul>
                </div>
      ...
      {/* Bottom Action Bar */}
      <div
        className={`bg-white border-t-2 border-gray-200 px-4 py-4 transition-all duration-300 shadow-lg ${
          showIntervention ? "blur-sm opacity-50" : ""
        }`}
      >
            ...
            <div className="space-y-4">
              ...
              <div className="relative w-full h-16 bg-gradient-to-r from-gray-300 to-gray-400 rounded-full overflow-hidden shadow-inner border-2 border-gray-400">
                ...
                <div
                  ...
                  style={{
                    left: `calc(${sliderValue}% - 32px)`,
                    maxLeft: "calc(100% - 64px)",
                  }}
                >
                  <div className="text-center">
                    <ChevronDown
                      className="w-8 h-8 text-orange-600 transform rotate-[-90deg]"
                      strokeWidth={3}
                    />
                  </div>
                </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-6 z-50 pointer-events-none">
          <div className="pointer-events-auto bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 border-4 ${currentConfig.borderColor}">
            ...
            {selectedScenario !== MASCOT_STATES.BLOCKED &&
              selectedScenario !== MASCOT_STATES.PRESSURE && (
                <div
                  className={`w-32 h-32 mx-auto mb-4 ${currentConfig.color} rounded-full flex items-center justify-center border-4 ${currentConfig.borderColor} relative`}
                >
                  {currentConfig.icon && (
                    <currentConfig.icon
                      className={`w-16 h-16 ${currentConfig.iconColor} absolute`}
                      strokeWidth={2}
                    />
                  )}
                  <div className="text-center">
                    <div
                      className={`text-xs font-bold ${currentConfig.iconColor} mt-16`}
                    >
                  ...
                  <div className="flex-1 relative">
                    ...
                    <div className="bg-green-50 border-2 border-green-300 rounded-2xl p-4 shadow-sm">
                      <p className="font-semibold text-green-900 text-sm mb-1">
                        {birdMessages[MASCOT_STATES.SAFE].title}
                      </p>
                      <p className="text-xs text-green-800 leading-relaxed">
                        {birdMessages[MASCOT_STATES.SAFE].message}
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="flex-1 relative">
                      ...
                      <div className="bg-yellow-50 border-2 border-yellow-300 rounded-2xl p-4 shadow-sm">
                        <p className="font-semibold text-yellow-900 text-sm mb-1">
                          {birdMessages[MASCOT_STATES.CAUTION].title}
                        </p>
                        <p className="text-xs text-yellow-800 leading-relaxed">
                          {birdMessages[MASCOT_STATES.CAUTION].message}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                    ...
                    <ul className="mt-2 space-y-2 text-sm text-gray-600">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Recipient name matches who you intend to pay
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-yellow-600 mt-0.5">•</span>
                  ...
                  <div className="flex-1 relative">
                    ...
                    <div className="bg-orange-50 border-2 border-orange-300 rounded-2xl p-4 shadow-sm">
                      <p className="font-semibold text-orange-900 text-sm mb-1">
                        {birdMessages[MASCOT_STATES.WARNING].title}
                      </p>
                      <p className="text-xs text-orange-800 leading-relaxed">
                        {birdMessages[MASCOT_STATES.WARNING].message}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <button
                    onClick={() => {
                      ...
                      alert(
                        "กำลังเชื่อมต่อไปยังศูนย์บริการลูกค้า K-Plus\n\nโทร: 02-8888888\nหรือ แชท: K-LIVE"
                      );
                      resetApp();
                    }}
                  ...
                  <div className="relative w-full h-16 bg-gradient-to-r from-gray-300 to-gray-400 rounded-full overflow-hidden shadow-inner border-2 border-gray-400">
                    ...
                    >
                      <div className="text-center">
                        <ChevronDown
                          className="w-8 h-8 text-red-600 transform rotate-[-90deg]"
                          strokeWidth={3}
                        />
                      </div>
                    </div>
